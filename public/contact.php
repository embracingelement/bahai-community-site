			...
			<div class="tabbable">
				<div class="container">
					<ul class="nav nav-tabs centerthetabs">
						<li class="active"><a href="#tab1" role="tab" data-toggle="tab" id="contacts-communitymap">Community Map</a></li>
						<li class="dropdown">
							<a class="dropdown-toggle" data-toggle="dropdown" href="#">Directories <b class="caret"></b></a>
							<ul class="dropdown-menu text-left">
								<li><a href="#tab3" data-toggle="tab" id="contacts-communityoffices">Community Offices</a></li>
					...
					<div class="tab-pane" id="tab3">
						<div class="container">
							<table class="table table-expanded table-no-border text-left">
								<thead>
									<tr>
										<th class="text-center blueblocktitle" colspan="2">
											Community Offices
										</th>
									</tr>
								</thead>
					...
					<div class="tab-pane" id="tab4">
						<div class="container">
							<table class="table table-expanded table-no-border text-left">
								...
								<thead>
									<tr>
										<td><em>Please contact the Los Angeles Baha'i Center if you wish to contact any of the Agencies listed below.</em></td>
									</tr>
								</thead>
								<tbody class="blue-striped agencieslist">
									<tr>
										<td>
											<strong>Sunday Devotional Program</strong>
										</td>
									</tr>
									<tr>
										<td>
											<strong>Community-Wide Nineteen Day Feasts</strong>
											<ul>
												<li>Arranges community-wide Nineteen Day Feasts.</li>
											</ul>
										</td>
									</tr>
									<tr>
										<td>
											<strong>Holy Days</strong>
											<ul>
												<li>Organizes Baha'i Holy Day events.</li>
											</ul>
										</td>
									</tr>
									<tr>
										<td>
											<strong>Archives and Research</strong>
											<ul>
												<li>Maintains community archives.</li>
											</ul>
										</td>
									</tr>
									<tr>
										<td>
											...
											<ul>
												<li>Organizes workshops on the Baha'i Faith and its teachings.</li>
											</ul>
										</td>
									</tr>
									<tr>
										<td>
											...
											<ul>
												<li>Coordinates social portions of community events.</li>
											</ul>
										</td>
									</tr>
									<tr>
										<td>
											<strong>Solace and Bereavement</strong>
											<ul>
												<li>Assists community members who have lost a loved one.</li>
												<li>Organizes educational workshops on Baha'i burials and the writing of a will.</li>
											</ul>
										</td>
									</tr>
									<tr>
										<td>
											...
											<ul>
												<li>Educates the community about the Baha'i Fund.</li>
												<li>Oversees all fundraising efforts in the community.</li>
											</ul>
											Please note:
											<ul>
												<li>Any fundraising activity must be approved by the Spiritual Assembly.</li>
												<li>Only Baha'is may contribute to the Baha'i Fund.</li>
												<li>Donations from groups and individuals who are not Baha'i are neither solicited nor accepted.</li>
											</ul>
										</td>
									...
									<tr>
										<td>
											<strong>Annual Elections</strong>
											<ul>
												<li>Organizes and administers the annual election of the nine members of the Spiritual Assembly of Los Angeles.</li>
												<li>Ensures that the election takes place in a spiritual environment, and that it follows Baha'i election procedures.</li>
												<li>Helps increase voter participation.</li>
											</ul>
										</td>
									</tr>
									<tr>
									...
									<tr>
										<td>
											...
											<ul>
												<li>Records and documents community events.</li>
												<li>Produces community videos.</li>
											</ul>
										</td>
									</tr>
									<tr>
									...
									<tr>
										<td>
											<strong>Community Website</strong>
										</td>
									</tr>
								</tbody>
							</table>
		...
		function initialize() {
		    ...
		    map.data.addListener('click', function(event) {
				...
				if (event.feature.getProperty("APC") == undefined) {
					...
					infoWindow.setContent("<div class='text-left infowindow' id='contacts-map-" + event.feature.getProperty("APC").replace(" ", "-") + "'><p><h4>" + event.feature.getProperty("APC") + "<br /><small>" + event.feature.getProperty("NAME_ALF") + "</small></h4></p><p>Baha'is are working to transform the spiritual life of Los Angeles through children's classes, junior youth groups, study circles, and devotional gatherings.</p>To get involved with one of these activities in " + event.feature.getProperty("APC") + ", please contact its " + event.feature.getProperty("APC") + " coordinator:</p>" + areacontacts + feastcontact + "</div>");
				}
